...
//outliers/historic rosters
...

  {
    ...
    players: [
      ...
      { name: "k0nfig", roles: ["Rifler"], firepower: 94, consistency: 87 },
      { name: "Magisk", roles: ["Rifler"], firepower: 92, consistency: 89 },
...

  {
    ...
    players: [
      ...
      { name: "fREAKAZOiD", roles: ["Rifler"], firepower: 84, consistency: 79 },
    ]
  },
